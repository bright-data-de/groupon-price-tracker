...
Info  : https://brightdata.de/products/insights/price-tracker/groupon
"""
...
# https://brightdata.de/products/web-scraper/groupon
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Groupon scraper at: https://brightdata.de/products/web-scraper/groupon\n"
